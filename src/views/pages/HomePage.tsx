...
const HomePage: FC = () => {
  return (
    <div className="mx-auto w-10/12">
      <div className="p-4 w-full text-left bg-white rounded-lg border shadow-md sm:p-8 dark:bg-gray-800 dark:border-gray-700">
        ...
        <h2 className="mb-5 text-2xl text-left font-extrabold tracking-tight text-gray-900 dark:text-white">We invest in the world’s potential</h2>
